...
public class RegistrarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCPF.setText("42505559845");
        txtNome.setText("Gustavo Gusmão");
        rdoSexo.check(R.id.registrar_rdo_masc);
        txtNascimento.setText("04/02/1977");
        txtEmail.setText("gustavo.gusmao@outlook.com");
        txtTelefone.setText("1147865781");
        txtEndereco.setText("R. Eudenice Mendes, 501");
        txtComplemento.setText("Blc. A - Apto. 501");
        txtBairro.setText("Cidade Junior");
        txtMunicipio.setText("Jardim Maceió");
        spnEstado.setSelection(5);
        txtCEP.setText("05721600");
        txtSenha.setText("chibatalalala");
    ...
    public class SFDonoPOST extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Toast.makeText(RegistrarActivity.this, "Usuário cadastro com sucesso!", Toast.LENGTH_SHORT).show();
